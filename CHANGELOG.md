...
- [v3.1.0 ... v3.1.1](https://github.com/Zuoqiu-Yingyi/siyuan-theme-dark-plus/compare/v3.1.0...v3.1.1)
...
- 调整设置面板卡片样式 | Adjust the style of the card in the settings panel.
...
- 移除 Monaco 编辑器组件 | Remove Monaco editor component.
