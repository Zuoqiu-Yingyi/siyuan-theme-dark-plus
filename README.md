...
| 文档块<br>document blocks                  | `render`                 | `index`<br>(使用空格分隔多个属性值 \| Separate multiple attribute values with spaces)                                                                                                                                                                                | 渲染当前块在文档中的序号<br>Renders the ordinal number of the current block in the document.                                                                                     |
| 文档块<br>document blocks                  | `render`                 | `content`<br>(使用空格分隔多个属性值 \| Separate multiple attribute values with spaces)                                                                                                                                                                              | 渲染输入框中的内容<br>Renders the contents of the input box.                                                                                                                     |
...
| 表格块<br>table blocks                     | `table-width`            | `auto`                                                                                                                                                                                                                                                               | 启动表格内容自动换行<br>Enable table content wraps.                                                                                                                              |
